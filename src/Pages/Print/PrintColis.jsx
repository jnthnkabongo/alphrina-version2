                ...
                <View style={styles.table}>
                      ...
                      {etatData.colis.length > 0 ? ( // Vérifiez s'il y a des colis
                        etatData.colis.map((colis, colisIndex) => (
                          <View key={colisIndex} style={styles.tableRow}>
                            ...
                            <View style={styles.tableCol}>
                              <Text style={styles.tableCell}>
                                {colis.nbrtotalcolis ?? "0"}
                              </Text>
                            </View>
                            <View style={styles.tableCol}>
                              <Text style={styles.tableCell}>
                                {colis.prixunitaire ?? "0"}
                              </Text>
                            </View>
                            <View style={styles.tableCol}>
                              <Text style={styles.tableCell}>
                  ...
                  <View style={styles.tableRow}>
                    <View style={styles.tableCol2}>
                      <Text style={styles.tableCell}>Nombre de colis</Text>
                    </View>
                    <View style={styles.tableCol2}>
                  ...
                  <View style={styles.tableRow}>
                    <View style={styles.tableCol2}>
                      <Text style={styles.tableCell}>Total payer:</Text>
                    </View>
                    <View style={styles.tableCol2}>
