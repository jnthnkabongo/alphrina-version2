                    ...
                    <Page size="A4" style={styles.page}>
                        <View style={[styles.row, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }]}>
                            <View style={[styles.colMd6, { alignItems: 'justify-between' }]}>
                                <Image source={{ uri: 'ab.jpg' }} style={{ width: 200, height: 100 }} />
                            </View>
                            <View style={[styles.colMd6, { alignItems: 'justify-end', marginRight: 16  }]}>
                                <Text style={{fontSize : 12, textDecoration: 'underline'}}>{`Le ${dateFormat(datanow, "dd/mm/yyyy")}`}</Text>
                            </View>
                        </View>
                       
                        <View style={styles.body}>
                            <View className="text-center">
                                <Text style={{fontSize : 15, textDecoration: 'underline'}}>Transactions du jour ({`Du ${dateFormat(datanow, "dd/mm/yyyy")}`})</Text>
                                <Text> </Text>
                            </View>
                            <View>
